...
$(document).ready(function() {
  $('button').click(function() {
    ...
    switch (clicked) {
    case 'A':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[0] + '</h3>' +'<p>' + info[0] + '</p></div>')
        break;
    case 'B':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[1] + '</h3>' +'<p>' + info[1] + '</p></div>')
        break;
    case 'C':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[2] + '</h3>' +'<p>' + info[2] + '</p></div>')
        break;
    case 'D':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[3] + '</h3>' +'<p>' + info[3] + '</p></div>')
        break;
    case 'E':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[4] + '</h3>' +'<p>' + info[4] + '</p></div>')
        break;
    case 'F':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[5] + '</h3>' +'<p>' + info[5] + '</p></div>')
        break;
    case 'G':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[6] + '</h3>' +'<p>' + info[6] + '</p></div>')
        break;
    case 'H':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[7] + '</h3>' +'<p>' + info[7] + '</p></div>')
        break;
    case 'I':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[8] + '</h3>' +'<p>' + info[8] + '</p></div>')
        break;
    case 'J':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[9] + '</h3>' +'<p>' + info[9] + '</p></div>')
        break;
    case 'K':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[10] + '</h3>' +'<p>' + info[10] + '</p></div>')
        break;
    case 'L':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[11] + '</h3>' +'<p>' + info[11] + '</p></div>')
        break;
    case 'M':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[12] + '</h3>' +'<p>' + info[12] + '</p></div>')
        break;
    case 'N':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[13] + '</h3>' +'<p>' + info[13] + '</p></div>')
        break;
    case 'O':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[14] + '</h3>' +'<p>' + info[14] + '</p></div>')
        break;
    case 'P':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[15] + '</h3>' +'<p>' + info[15] + '</p></div>')
        break;
    case 'Q':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[16] + '</h3>' +'<p>' + info[16] + '</p></div>')
        break;
    case 'R':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[17] + '</h3>' +'<p>' + info[17] + '</p></div>')
        break;
    case 'S':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[18] + '</h3>' +'<p>' + info[18] + '</p></div>')
        break;
    case 'T':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[19] + '</h3>' +'<p>' + info[19] + '</p></div>')
        break;
    case 'U':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[20] + '</h3>' +'<p>' + info[20] + '</p></div>')
        break;
    case 'V':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[21] + '</h3>' +'<p>' + info[21] + '</p></div>')
        break;
    case 'W':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[22] + '</h3>' +'<p>' + info[22] + '</p></div>')
        break;
    case 'X':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[23] + '</h3>' +'<p>' + info[23] + '</p></div>')
        break;
    case 'Y':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[24] + '</h3>' +'<p>' + info[24] + '</p></div>')
        break;
    case 'Z':
        $('.btninfo').replaceWith('<div class="btninfo"><h3>' + heading[25] + '</h3>' +'<p>' + info[25] + '</p></div>')
        break;
      default:
